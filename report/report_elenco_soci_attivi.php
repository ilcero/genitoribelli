...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A2', "ELENCO SOCI ATTIVI AL ".date("d-m-Y"));
...
header('Content-Disposition: attachment;filename="elenco_soci_attivi_'.date("d-m-Y").'.xls"');
